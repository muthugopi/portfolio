...
const projects = [
  ...
  {
    title: 'Anonyms for RIT',
    label: 'Django Full-stack application',
    description: 'Anonyms is an exclusive platform for RIT students that allows them to post content anonymously',
