    ...
    return (
        <section className="skills my-20">
            <div className='flex justify-even flex-col mb-[64px] items-center'>
                ...
                <p className='text-[18px] text-gray-400  text-center mt-6' >Technologies and tools I work with</p>
            </div>
            
            <div className="skills grid grid-cols-1 md:grid-cols-3 mx-auto max-w-7xl gap-y-5 justify-items-center">
                ...
                <SkillCard icon="bi-gear "  title="Backend Development" gradient='from-cyan-500 to-blue-500'  tech={["Node", "Express", "JWT"]}/>
            ...
            <div className='border border bg-slate-900/70 my-20 max-w-7xl mx-auto border-[#475569]/30 p-6 rounded-2xl card-shadow relative animation duration-300 overflow-hidden p-[32px] text-center '>
                <h1><i className="bi bi-code-slash text-purple-400 text-[48px]"></i></h1>
                <p className='text-[24px] font-semibold mb-[8px] '>Always Learning</p>
                <p className='text-[16px] text-gray-400 '>Constantly exploring new technologies and expanding my skill set to stay ahead in the ever-evolving tech landscape</p>
            </div>
        </section>
    )
}
