...
function Card(props) {
    return (
        <div className="w-[350px] bg-[var(--bg-card)] border text-center border-[#475569] p-[24px] hover:scale-105  rounded-xl transition-all duration-500 card-shadow hover:border-indigo-500">
